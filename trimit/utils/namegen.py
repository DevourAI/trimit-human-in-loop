# stolen from https://github.com/Atrox/haikunatorpy/blob/master/haikunator/haikunator.py
...
class Haikunator:
    ...
    def haikunate(
        self, delimiter="-", token_length=4, token_hex=False, token_chars="0123456789"
    ):
        """
...
def namegen(token_length=4):
    return haikunator.haikunate(token_length=token_length)


def timeline_namegen(token_length=4):
    return "timeline-" + namegen(token_length=token_length)


def project_namegen(token_length=4):
    return "project-" + namegen(token_length=token_length)
